...
#define defaults_h
  ...
  #define DEFAULT_Z_STEPS_PER_MM 416.66
  #define DEFAULT_X_MAX_RATE 250.00 // mm/min
  #define DEFAULT_Y_MAX_RATE 500.00 // mm/min
  #define DEFAULT_Z_MAX_RATE 250 // mm/min
